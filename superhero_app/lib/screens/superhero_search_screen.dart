        ...
        children: [
          Padding(
            ...
            child: TextField(
              ...
              onChanged: (text) {
                setState(() {
                  isTextEmpity = text.isEmpty;
                  _superheroInfo = _repository.fetchSuperHeroInfo(text);
                });
              },
            ),
          ),
          bodyList(isTextEmpity),
        ],
      ),
    );
  }

  FutureBuilder<SuperheroResponse?> bodyList(bool isTextEmpity) {
    return FutureBuilder(
      future: _superheroInfo,
      builder: (context, snapshot) {
        if (isTextEmpity) return Center(child: Text("Introduce un nombre"));
